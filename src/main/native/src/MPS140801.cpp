...
#include "tw_edu_sju_ee_eea_jni_mps_MPS140801.h"
...
JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_loadLibrary
...
JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_construct
...
JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_destruct
(JNIEnv *env, jobject obj) {
...
JNIEXPORT jboolean JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_isAlive
(JNIEnv *env, jobject obj) {
    return (getStruct(env, obj)->DeviceHandle != NULL);
}

JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_openDevice
(JNIEnv *env, jobject obj, jint deviceNumber) {
    getStruct(env, obj)->DeviceHandle = MPS_OpenDevice(deviceNumber);
}

JNIEXPORT jint JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_getDeviceId
(JNIEnv *env, jobject obj) {
    return MPS_GetDeviceID(getStruct(env, obj)->DeviceHandle);
}

JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_configure
(JNIEnv *env, jobject obj, jint sampleRate) {
    MPS_Configure(sampleRate, getStruct(env, obj)->DeviceHandle);
}

JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_dataIn
...
JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_start
(JNIEnv *env, jobject obj) {
    MPS_Start(getStruct(env, obj)->DeviceHandle);
}

JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_stop
(JNIEnv *env, jobject obj) {
    MPS_Stop(getStruct(env, obj)->DeviceHandle);
}

JNIEXPORT void JNICALL Java_tw_edu_sju_ee_eea_jni_mps_MPS140801_closeDevice
(JNIEnv *env, jobject obj) {
